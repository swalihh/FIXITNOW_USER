      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: BlocListener<SavedBloc, SavedState>(
            ...
            child: BlocConsumer<PaintingBloc, PaintingState>(
              listener: (context, state) {
                if (state is FetchAllPaintersErrorState) {
                  ScaffoldMessenger.of(context)
                      .showSnackBar(SnackBar(content: Text(state.message)));
                }
              },
              builder: (context, state) {
                if (state is FetchAllPaintersSuccessState &&state.servicers.isNotEmpty) {
