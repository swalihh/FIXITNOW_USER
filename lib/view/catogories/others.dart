      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: BlocListener<SavedBloc, SavedState>(
            ...
            child: BlocConsumer<OthersBloc,OthersState>(
              listener: (context, state) {
                if (state is GetAllOtherServicersErrorState) {
                  ScaffoldMessenger.of(context)
                      .showSnackBar(SnackBar(content: Text(state.message)));
                }
              },
              builder: (context, state) {
                if (state is GetAllOtherServicersSuccessState && state.servicers.isNotEmpty) {
